            ...
            <div className="home grid grid-cols-1 md:grid-cols-1 grid-flow-column gap-12 m-2">
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-center mt-4">.NET 6</p>
                    </motion.div>
                    <motion.div
                        variants={buttonVariants}
                        whileHover="hover"
                    ...
                    <motion.div
                        ...
                        data-aos-duration="2000"
                    >
                        <SiBootstrap style={{ height: 100, width: 100 }} />
                        <p className="text-center mt-4">Bootstrap</p>
                    </motion.div>
                    <motion.div
                        variants={buttonVariants}
                        whileHover="hover"
                    ...
                    <motion.div
                        ...
                        data-aos-duration="2000"
                    >
                        <SiChakraui style={{ height: 100, width: 100 }} />
                        <p className="text-center mt-4">Chakra-UI</p>
                    </motion.div>
                </div>
