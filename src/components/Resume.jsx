            ...
            >
                <div>
                    ...
                    <div data-aos="zoom-out-right" data-aos-duration="2000">
                        <p className="mt-4 text-xl">
                            Junior Software Engineer - Backend | LetCargo LLC
                        </p>
                        <p>August 2021 – Present</p>
                        <ul>
                            <li className="mt-4 ml-2">
                                - Created RESTful APIs to serve wen & mobile
                                applications using .NET core 6.
                            </li>
                            <li className="mt-4 ml-2">
                                - Well-versed with Repository pattern with Unit
                                of Work & CQRS + Mediatr pattern.
                            </li>
                            <li className="mt-4 ml-2">
                                - Experience with Ocelot API gateway for
                                Microservices pattern.
                            </li>
                            <li className="mt-4 ml-2 mb-8">
                                - Worked on geographical mapping services.
                            </li>
                        </ul>
                    </div>
                    <div data-aos="zoom-out-right" data-aos-duration="2000">
                ...
                <div>
                    ...
                    <div data-aos="zoom-out-right" data-aos-duration="2000">
                        ...
                        <ul>
                            <li className="mt-4 ml-2 mb-8">
                                - 3.03 CGPA. Senior student/Final year. Expected
                                to graduate in June 2021.
                            </li>
                        </ul>
                    </div>
                    <div data-aos="zoom-out-right" data-aos-duration="2000">
                        ...
                        <ul>
                            <li className="mt-4 ml-2 mb-8">
                                - 81% overall in AISSC Computer Science–Math
                                curriculum.
                            </li>
                        </ul>
                    </div>
